...
ClapTrap::ClapTrap(): _name("NoNamed"), _hitPoints(10), _energyPoints(10), _attackDamage(0) { std::cout << "| Default Constructor Called |" << std::endl; }

ClapTrap::ClapTrap(const std::string &name): _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) { std::cout << "ClapTrap " << GREEN << this->_name << RESET << " is born!" << std::endl; }
